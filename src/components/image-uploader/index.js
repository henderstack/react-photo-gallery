...
class DropLoader extends Component {
  ...
  onDragEnter(evt) {
    ...
    // Count the DropLoader and any children that are entered.
  ...
  onDragOver(evt) {
    ...
    try {
      ...
      // the DropLoader, causing the browser the crash when the file dialog is closed.
  ...
  onDragLeave(evt) {
    ...
    // Only deactivate once the DropLoader and all children have been left.
  ...
  onClick(evt) {
    ...
    if (!disableClick) {
      ...
      // see: https://github.com/react-DropLoader/react-DropLoader/issues/450
      if (isIeOrEdge()) {
...
DropLoader.propTypes = {
   ...
   * See: https://github.com/react-DropLoader/react-DropLoader/issues/276
   */
  accept: PropTypes.string,

  /**
   * Contents of the DropLoader
   */
  children: PropTypes.oneOfType([PropTypes.node, PropTypes.func]),

  /**
   * Disallow clicking on the DropLoader container to open file dialog
   */
  disableClick: PropTypes.bool,

  /**
   * Enable/disable the DropLoader entirely
   */
  ...
  /**
   * className to apply when DropLoader is disabled
   */
  ...
  /**
   * CSS styles to apply when DropLoader is disabled
   */
